...
config.js.admin.app_files = ['aquery', 'slugify', 'form_delete_button', 'autofill_image_name', 'add_tags', 'reorder_images', 'set_cover_image', 'add_images_to_post'];
...
config.js.public.app_files = ['aquery', 'display_album'];
